...
<body>
    ...
    <div class="container">
        <a href="agregar_ag.php" class="btn btn-primary ms-3 mb-3 " style="font-family: 'Courier New', Courier, monospace; color: white;">
                        ...
                        <tbody class="text-center" style="font-family:'Courier New',Courier, monospace">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo '<a href="Editar_ag.php?id_rh=' . $row['id_rh'] . '" class="btn btn-primary ms-8" title="Editar">
                                        ...
                                        <?php echo '<a href="borrar_ag.php?id_rh=' . $row['id_rh'] . '" class="btn btn-danger ms-8" title="Borrar">
