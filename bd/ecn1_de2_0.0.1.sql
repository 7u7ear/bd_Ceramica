...
-- Tiempo de generación: 01-12-2024 a las 11:29:42
...
CREATE TABLE IF NOT EXISTS `estudiantes` (
  ...
  `apellido y nombre` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL,
  `dni` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `Curso / div.` int NOT NULL,
  PRIMARY KEY (`id_estudiante`),
  KEY `rel_Cur/div` (`Curso / div.`)
...
INSERT INTO `estudiantes` (`id_estudiante`, `apellido y nombre`, `dni`, `Curso / div.`) VALUES
(1, 'Arnau, Matias Ezequiel ', '27774958', 1),
(2, 'Arnau, Celeste ', '53418187', 1),
(3, 'Perez, Juan', '11391123', 1);
...
--
-- Estructura de tabla para la tabla `familiasestudiantes`
--

DROP TABLE IF EXISTS `familiasestudiantes`;
CREATE TABLE IF NOT EXISTS `familiasestudiantes` (
...
--
-- Volcado de datos para la tabla `familiasestudiantes`
--

INSERT INTO `familiasestudiantes` (`id_famEst`, `1_Vinculo Estudiante`, `1_apellido y nombre`, `1_dni`, `1_domicilio`, `1_mail`, `1_Telefono`, `2_Vinculo Estudiante`, `2_apellido y nombre`, `2_dni`, `2_mail`, `2_Telefono`, `observaciones`, `id_estudiante`) VALUES
...
CREATE TABLE IF NOT EXISTS `inscripciones` (
  ...
  `curso` int NOT NULL,
  `Ciclo Lectivo` int NOT NULL,
  PRIMARY KEY (`id_inscripcion`),
  KEY `id_Curso` (`curso`),
  KEY `rel_cl` (`Ciclo Lectivo`),
...
INSERT INTO `inscripciones` (`id_inscripcion`, `estudiante`, `curso`, `Ciclo Lectivo`) VALUES
(3, 1, 1, 1),
(4, 2, 1, 1);
...
ALTER TABLE `estudiantes`
  ADD CONSTRAINT `rel_Cur/div` FOREIGN KEY (`Curso / div.`) REFERENCES `curso_division` (`id_curso_division`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--
-- Filtros para la tabla `familiasestudiantes`
--
ALTER TABLE `familiasestudiantes`
...
ALTER TABLE `inscripciones`
  ...
  ADD CONSTRAINT `rel_cl` FOREIGN KEY (`Ciclo Lectivo`) REFERENCES `ciclo_lectivo` (`id_cl`) ON DELETE RESTRICT ON UPDATE RESTRICT;
