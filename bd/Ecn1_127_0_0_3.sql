...
-- Tiempo de generación: 18-11-2024 a las 23:53:23
...
(7410000, 'colapinto, juan', '2074125896', 7412, 854796, '2024-11-18', '0000-00-00', 0);
...
CREATE TABLE IF NOT EXISTS `estudiantes` (
  ...
  `modalidad` enum('BEC','TCA','AUX') CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL,
...
INSERT INTO `estudiantes` (`id_estudiante`, `apellido y nombre`, `dni`, `modalidad`) VALUES
(1, 'Arnau, Matias Ezequiel ', '27774958', 'BEC'),
(2, 'Arnau, Celeste ', '53418187', 'BEC'),
(3, 'Perez, Juan', '11391123', 'BEC');
...
CREATE TABLE IF NOT EXISTS `familia` (
  ...
  `id_rh` int NOT NULL,
  `parentesco` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL,
